...
pub fn parse_identify(msg: &Identify) -> Ruddermessage {
    ...
    merge(
        ...
        msg.context.clone().unwrap_or(json!({})),
    );

    let sent_at = Utc::now();
    let original_timestamp = msg.original_timestamp.or(Some(sent_at));
    ...
    for i in &msg.batch {
        match i {
            ...
            BatchMessage::Track(a_) => {
                batch.push(Rudderbatchmessage::Track(Ruddertrack {
                    user_id: a_.user_id.clone(),
                    anonymous_id: a_.anonymous_id.clone(),
            ...
            BatchMessage::Page(a_) => {
                batch.push(Rudderbatchmessage::Page(Rudderpage {
                    user_id: a_.user_id.clone(),
                    anonymous_id: a_.anonymous_id.clone(),
                    name: a_.name.clone(),
                    properties: a_.properties.clone(),
            ...
            BatchMessage::Screen(a_) => {
                batch.push(Rudderbatchmessage::Screen(Rudderscreen {
                    user_id: a_.user_id.clone(),
                    anonymous_id: a_.anonymous_id.clone(),
                    name: a_.name.clone(),
                    properties: a_.properties.clone(),
            ...
            BatchMessage::Group(a_) => {
                batch.push(Rudderbatchmessage::Group(Ruddergroup {
                    user_id: a_.user_id.clone(),
                    anonymous_id: a_.anonymous_id.clone(),
            ...
            BatchMessage::Alias(a_) => {
                batch.push(Rudderbatchmessage::Alias(Rudderalias {
                    user_id: a_.user_id.clone(),
